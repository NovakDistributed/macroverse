let SingleStarPrototype = artifacts.require("SingleStarPrototype");
let UnrestrictedAccessControl = artifacts.require("UnrestrictedAccessControl");

contract('SingleStarPrototype', function(accounts) {
  it("should initially reject queries", async function() {
    let instance = await SingleStarPrototype.deployed()
