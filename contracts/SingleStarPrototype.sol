 ...
 */
contract SingleStarPrototype is ControlledAccess {
    using RNG for *;
     ...
     */
    function SingleStarPrototype(bytes32 baseSeed, address accessControlAddress) ControlledAccess(AccessControl(accessControlAddress)) {
