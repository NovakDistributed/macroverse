 ...
 *
 * Some code here generates properties of objects (i.e. stars) that are
 * necessary for generating planetary systems but which weren't generated by
 * the originally deployed MacroverseStarGenerator.
 *
